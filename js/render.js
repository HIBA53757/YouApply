...
offers.forEach(offer => {
    ...
    div_Company_logo.textContent =
        offer.company.charAt(0).toUpperCase();


    // CONTAINER INFO
    div_contain_info_card.setAttribute(
        "class",
    ...
    // DOT 1
    span_dot_1.setAttribute(
        "class",
        "w-1 h-1 rounded-full bg-slate-400"
    );


    // LOCATION
    span_location.setAttribute(
        "class",
        "text-slate-500"
    );
